...
git@github.com:olgakurg/Auth_sprint_2.git

Все интегрированные сервисы могут быть запущены через общий docker-compose:
docker-compose up --build,

Для отдельного развертывания каждого сервиса в каталогах сервисов есть конфигурации nginx и docker-compose.yml.

Для успешного запуска сервисов необходимы файлы .env, образцы для заполнения приведены в .env_example файлах.
